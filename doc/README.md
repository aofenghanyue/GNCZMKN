...
| 使用拉偏和 SimFlow | [03-mission-configuration.md](03-mission-configuration.md) | [02-core-concepts.md](02-core-concepts.md), [04-extension-guide.md](04-extension-guide.md), [06-reference.md](06-reference.md) |
...
- [05-architecture.md](05-architecture.md)：维护者视角的源码导览、SimFlow 执行模型、关键类职责、生命周期和调度机制。
- [06-reference.md](06-reference.md)：CLI、SimFlow 配置、源码入口、type id、服务 id、配置字段速查。
