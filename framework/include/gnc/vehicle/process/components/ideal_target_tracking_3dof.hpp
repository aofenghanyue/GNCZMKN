...
class IdealTargetTracking3Dof final
    : public gnc::core::ComponentBase,
      public ITargetTracking3Dof,
      public gnc::interfaces::IObservable {
public:
    IdealTargetTracking3Dof()
        : ComponentBase("IdealTargetTracking3Dof") {}
    ...
    void update(double) override {
        const auto& seeker = seeker_->seekerMeasurement3Dof();
    ...
    const TargetTrack3Dof& targetTrack3Dof() const override { return track_; }
...
private:
    gnc::vehicle::input::ISeeker3Dof* seeker_ = nullptr;
    std::string seeker_lookup_name_ = "seeker";
    TargetTrack3Dof track_{};
};
