...
class IdealSatelliteNav6Dof final : public gnc::core::ComponentBase,
                                    public ISatelliteNav6Dof,
                                    public gnc::interfaces::IObservable {
public:
    IdealSatelliteNav6Dof() : ComponentBase("IdealSatelliteNav6Dof") {}
    ...
    void update(double) override {
        ...
        measurement_.attitude_body_to_nue = truth.state.attitude_body_to_nue;
