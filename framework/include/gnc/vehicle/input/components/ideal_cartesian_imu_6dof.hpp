...
class IdealCartesianImu6Dof final : public gnc::core::ComponentBase,
                                    public IImu6Dof,
                                    public gnc::interfaces::IObservable {
public:
    IdealCartesianImu6Dof() : ComponentBase("IdealCartesianImu6Dof") {}
    ...
    void update(double) override {
        ...
        measurement_.local_acceleration_nue_mps2 = truth.acceleration_mps2;
