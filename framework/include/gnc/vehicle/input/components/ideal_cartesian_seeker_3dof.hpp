...
class IdealCartesianSeeker3Dof final : public gnc::core::ComponentBase,
                                       public ISeeker3Dof,
                                       public gnc::interfaces::IObservable {
public:
    IdealCartesianSeeker3Dof()
        : ComponentBase("IdealCartesianSeeker3Dof") {}
    ...
    void update(double) override {
        const auto& own = truth_->getCartesian3DoFTruth();
