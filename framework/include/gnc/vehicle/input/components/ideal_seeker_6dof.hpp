...
class IdealSeeker6Dof final : public gnc::core::ComponentBase,
                              public ISeeker6Dof,
                              public gnc::interfaces::IObservable {
public:
    IdealSeeker6Dof() : ComponentBase("IdealSeeker6Dof") {}
    ...
    void update(double) override {
        const auto& own = truth_->getLocalSpherical6DoFTruth();
