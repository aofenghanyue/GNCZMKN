...
class IdealCartesianAirData6Dof final : public gnc::core::ComponentBase,
                                        public IAirData6Dof,
                                        public gnc::interfaces::IObservable {
public:
    IdealCartesianAirData6Dof()
        : ComponentBase("IdealCartesianAirData6Dof") {}
    ...
    void update(double) override {
        ...
        const auto sample = atmosphere_->sample(truth.state.position_m.z());
        measurement_.altitude_m = truth.state.position_m.z();
        measurement_.speed_mps = truth.state.velocity_mps.norm();
