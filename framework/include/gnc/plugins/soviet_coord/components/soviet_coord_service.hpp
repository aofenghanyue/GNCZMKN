...
#include "gnc/plugins/soviet_coord/internal/coordinate_tree.hpp"
#include "gnc/plugins/soviet_coord/internal/frame_ids.hpp"
#include "gnc/plugins/soviet_coord/internal/provider_contracts.hpp"
#include "gnc/plugins/soviet_coord/internal/rotation_formulas.hpp"
...
class SovietCoordService final : public ISovietCoordService {
public:
    ...
    void bindProviders(gnc::core::ScopedRegistry& registry) {
        earth_ = registry.requireByName<gnc::plugins::environment::IEarth>(bindings_.earth);
