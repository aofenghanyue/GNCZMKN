...
class IdealEngagementSummaryCartesian6Dof final
    : public gnc::core::ComponentBase,
      public gnc::interfaces::ISummaryObserver {
public:
    IdealEngagementSummaryCartesian6Dof()
        : ComponentBase("IdealEngagementSummaryCartesian6Dof") {}
    ...
    void writeSummary(std::ostream& out) const override {
        out << "Ideal Cartesian 6DOF Engagement Summary\n";
