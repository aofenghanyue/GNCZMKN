...
class IdealEngagementSummary3Dof final
    : public gnc::core::ComponentBase,
      public gnc::interfaces::ISummaryObserver {
public:
    IdealEngagementSummary3Dof()
        : ComponentBase("IdealEngagementSummary3Dof") {}
    ...
    void update(double) override {
        ...
        final_interceptor_speed_mps_ = interceptor.state.speed_mps;
    ...
    void writeSummary(std::ostream& out) const override {
        out << "Ideal 3DOF Engagement Summary\n";
