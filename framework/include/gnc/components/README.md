...
- 想做自己的项目扩展：优先在 `user/<project>/components/` 下新增组件
- 想沉淀跨项目复用、语义稳定的公共组件：再考虑放到 `framework/include/gnc/components/`
- 想重写某个 starter component：更推荐复制思路到 `user/<project>/components/`，而不是直接把它当作唯一官方模型继续堆逻辑
